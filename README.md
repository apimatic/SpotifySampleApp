...
```
Build a "Music DNA" web app with Next.js, TypeScript, and Tailwind CSS that uses
the Spotify Web API (via APIMatic-generated SDK) to analyze a user's listening
history and generate a shareable personality card with radar chart, top genres,
obscure artist pick, and downloadable PNG export.
```
